...
func TestRewriteOpenAIImagesResponseWithTOSUploadsBase64(t *testing.T) {
	...
	rewritten, err := rewriteOpenAIImagesResponseWithStorage(context.Background(), body, storage)
	require.NoError(t, err)
...
func TestRewriteOpenAIImagesResponseWithTOSDisabledLeavesBody(t *testing.T) {
	...
	rewritten, err := rewriteOpenAIImagesResponseWithStorage(context.Background(), body, nil)
	require.NoError(t, err)
...
func TestRewriteOpenAIImagesCompletedEventWithTOS(t *testing.T) {
	...
	rewritten, err := rewriteOpenAIImagesEventPayloadWithStorage(context.Background(), payload, storage)
	require.NoError(t, err)
...
func TestRewriteOpenAIImagesMultilineSSEEventWithTOS(t *testing.T) {
	...
	rewritten, err := rewriteOpenAIImagesSSEEventLinesWithStorage(context.Background(), lines, storage)
	require.NoError(t, err)
